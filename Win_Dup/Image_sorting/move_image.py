...
# Example usage
source_directory = r'C:\Users\PRDA5207\Desktop\CloudVision\Screenshot_capture'  # Replace with the actual source directory where screenshots are saved
destination_directory = r'C:\Users\PRDA5207\Desktop\CloudVision\Image_search'  # Replace with the actual destination directory
#new_filename = 'image_object_to_be_detected_' + datetime.now().strftime('%Y%m%d_%H%M%S')  # Generates a timestamped filename
new_filename = 'image_object_to_be_detected'  # Generates a timestamped filename
